// --------------------------------------------------------------------------------
// <copyright file="BrowseForFolderHelper.cs" company="SpitOut Project">
//   Copyright (c) 2016 Alex Kozlov
// </copyright>
// <summary>
//   Defines the BrowseForFolderHelper type.
// </summary>
// --------------------------------------------------------------------------------
...
namespace SpitOut.Models
{
    ...
    public class BrowseForFolderHelper
    {
        ...
        public string SelectFolder(string caption, string initialPath, IntPtr parentHandle)
        {
            ...
            bi.ulFlags = this.BIF_SHAREABLE | this.BIF_USENEWUI;
            bi.lpfn = new BrowseCallBackProc(this.OnBrowseEvent);
